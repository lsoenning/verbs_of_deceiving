...
plot1 <- xyplot(1~1, type="n", xlim=c(-5,.5), ylim=c(0,1),
       ...
       panel=function(x,y){
         ...
         panel.text(x=-5, y=-.19, label="Variety: AmE; Genre: Fiction", adj=0, cex=.7, col="grey30")
       })
...
plot2 <- xyplot(1~1, type="n", xlim=c(.8, 2.2), ylim=c(0,1),
       ...
       panel=function(x,y){
         ...
         panel.text(x=.8, y=-.19, label="Comparison at the cross-varietal", 
...
cairo_pdf("./figures/replacement_summary.pdf", width=6, height=3)
print(plot1, position=c(0,.05,.55,1), more=T)
print(plot2, position=c(.58,.05,.86,1))
dev.off()
```

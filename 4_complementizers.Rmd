...
```{r}
str(comp_verbal)
m_comp_verbal <- glm(complementizer_present ~ year_c + variety + verb + negation + genre_binary + transitivity,
...
```{r}
m_comp_nominal <- glm(complementizer_present ~ year_c + variety + verb + negation + genre_binary + transitivity,
...
```{r}
str(comp_none)
m_comp_none <- glm(complementizer_present ~ year_c + variety + verb + negation + genre_binary + transitivity,
